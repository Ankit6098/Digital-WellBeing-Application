...
public class MainActivity extends AppCompatActivity {
    ...
    private LinearLayout mSort, enableLayout, appUsageLayout, appDataUsageLinear, topLayout;
    private SwitchCompat mSwitch;
    private TextView mSwitchText, errorText, dateTextView, totalTime, percentageText;
    ...
    private int workModeTime, educationModeTime, healthModeTime, focusModeTime;
    private TextView workTimeText, educationTimeText, healthTimeText, focusTimeText, permissionText;

    private NestedScrollView nestedScrollView;
    private LottieAnimationView permissionLottie;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        permissionLottie = findViewById(R.id.permission_lottie);
        nestedScrollView = findViewById(R.id.nested_scroll_view);
        permissionText = findViewById(R.id.permission_text);

        workTimeText = findViewById(R.id.work_time_textview);
        educationTimeText = findViewById(R.id.education_time_textview);
        healthTimeText = findViewById(R.id.social_time_textview);
        focusTimeText = findViewById(R.id.focus_time_textview);
...
//                        overridePendingTransition(0, 0);
    ...
    private void getModesTime() {
        workModeTime = PreferenceManager.getInstance().getInt("workTime");
        educationModeTime = PreferenceManager.getInstance().getInt("educationTime");
        healthModeTime = PreferenceManager.getInstance().getInt("healthTime");
        focusModeTime = PreferenceManager.getInstance().getInt("focusTime");

        workTimeText.setText(String.format(getResources().getString(R.string.total), AppUtil.formatMilliSeconds(workModeTime)));
        educationTimeText.setText(String.format(getResources().getString(R.string.total), AppUtil.formatMilliSeconds(educationModeTime)));
        healthTimeText.setText(String.format(getResources().getString(R.string.total), AppUtil.formatMilliSeconds(healthModeTime)));
        focusTimeText.setText(String.format(getResources().getString(R.string.total), AppUtil.formatMilliSeconds(focusModeTime)));
...
//        });
    ...
    private void process() {
        if (DataManager.getInstance().hasPermission(getApplicationContext())) {
            ...
            permissionLottie.setVisibility(View.GONE);
...
//        return getResources().getString(R.string.sort_by);
    ...
    public void healthIntent(View view) {
        startActivity(new Intent(MainActivity.this, SocialActivity.class).putExtra("activity", "home"));
        overridePendingTransition(0, 0);
    }

    public void learnIntent(View view) {
        startActivity(new Intent(MainActivity.this, EducationActivity.class).putExtra("activity", "home"));
        overridePendingTransition(0, 0);
    }

    public void workIntent(View view) {
        startActivity(new Intent(MainActivity.this, WorkActivity.class).putExtra("activity", "home"));
        overridePendingTransition(0, 0);
    }
