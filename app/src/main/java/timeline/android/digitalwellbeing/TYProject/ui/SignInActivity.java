...
public class SignInActivity extends AppCompatActivity {
    private TextInputEditText emailEditText, passwordEditText, forgotEmailInput;
    private TextInputLayout emailEditLayout, forgotEmailLayout;
    private Button loginButton, forgotSubmitButton;
    private LottieAnimationView tickLottie, errorLottie, loadingLottie, arrowDownLottie, forgotSuccessLottie;
    private FloatingActionButton googleFab, fbFab, phoneFab;
    private TextView errorText, helloTextView, forgotPasswordLink;
    private LinearLayout errorLayout, accountLayout;
    ...
    private TextView successfullySentTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        accountLayout = findViewById(R.id.forgot_password_account_layout);
//        successfullySentTextView = findViewById(R.id.successfully_sent_textview);
        arrowDownLottie = findViewById(R.id.arrow_lottie);
        forgotEmailInput = findViewById(R.id.forgot_email_input);
        forgotEmailLayout = findViewById(R.id.forgot_email_layout);
        forgotSubmitButton = findViewById(R.id.forgot_submit_button);
        forgotSuccessLottie = findViewById(R.id.forgot_success_lottie);

        arrowDownLottie = findViewById(R.id.arrow_lottie);
        emailEditText = findViewById(R.id.sign_email_input);
        emailEditLayout = findViewById(R.id.sign_email_layout);
        ...
        forgotPasswordLink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                emailEditLayout.setVisibility(View.INVISIBLE);
...
//                    Toast.makeText(getApplicationContext(),"Hello Javatpoint",Toast.LENGTH_SHORT).show();
        ...
        arrowDownLottie.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                int visible = (errorText.getVisibility() == View.GONE) ? View.VISIBLE : View.GONE;
                TransitionManager.beginDelayedTransition(infoCard, new Slide(Gravity.TOP));
                ...
                forgotSuccessLottie.setVisibility(View.GONE);
                forgotEmailLayout.setVisibility(View.VISIBLE);
                forgotSubmitButton.setVisibility(View.VISIBLE);
            }
        });
    ...
    private void resetPassword() {
        ...
        if (!Patterns.EMAIL_ADDRESS.matcher(email).matches()) {
            forgotEmailInput.setError("Please provide valid Email!");
            forgotEmailInput.requestFocus();
            return;
        }
        ...
        mAuth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    forgotSubmitButton.setVisibility(View.GONE);
                    forgotSuccessLottie.setVisibility(View.VISIBLE);
                    forgotSuccessLottie.playAnimation();

                    Toast.makeText(SignInActivity.this, "Check your email to reset your password!", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(SignInActivity.this, "Try again! Something wrong happened!", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
