...
public class PreferenceManager {
    ...
    public static final String PREF_WORK_TOGGLE = "work_mode";
    public static final String PREF_EDUCATION_TOGGLE = "education_mode";
    public static final String PREF_SOCIAL_TOGGLE = "social_mode";
    public static final String PREF_FOCUS_TOGGLE = "focus_mode";
    ...
    public boolean getWorkSettings(String key) {
        return mShare.getBoolean(key, false);
    }

    public boolean getEducationSettings(String key) {
        return mShare.getBoolean(key, false);
    }

    public boolean getSocialSettings(String key) {
        return mShare.getBoolean(key, false);
    }

    public boolean getFoucsSettings(String key) {
        return mShare.getBoolean(key, false);
    }
