                                        ...
                                        FirebaseDatabase.getInstance().getReference("Users")
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (task.isSuccessful()) {
                                                    ...
                                                    helloTextView.setText("User Registered Successfully!");
                                                    helloTextView.setTextColor(Color.parseColor("#0065FF"));
                                                    TransitionManager.beginDelayedTransition(infoCard, new Slide(Gravity.TOP));
                                                    infoCard.setVisibility(View.VISIBLE);

                                                    blurView1.setTranslationY(-200);
                                                    ObjectAnimator animator = ObjectAnimator.ofFloat(blurView1, "translationY", 0);
...
//                    Toast.makeText(getApplicationContext(),"Hello Javatpoint",Toast.LENGTH_SHORT).show();
        ...
        optionsCard.setOnTouchListener(new OnSwipeTouchListener(RegisterActivity.this) {
            ...
            public void onSwipeTop() {
                ObjectAnimator cardAnimation = ObjectAnimator.ofFloat(optionsCard, "translationY", -810f);
                cardAnimation.setDuration(300);
                cardAnimation.start();
...
//                .setBlurAutoUpdate(true);
    ...
    private void createRequest() {
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("437144230302-d6rtq24botcunh549dgskn4dqlukefli.apps.googleusercontent.com")
                .requestEmail()
                .build();
...
//        optionsCard.setVisibility(View.VISIBLE);
    ...
    public void hideInfo(View view) {
        ...
        blurView1.setAlpha(0);
        blurView1.animate().alpha(1).setDuration(300).setStartDelay(0).start();
